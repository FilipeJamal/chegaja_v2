...
| M2.20.9.2 | FECHADO | Politica global de admissao e bloqueio de servicos ilicitos |
...
`CategoryApprovalService` e as Rules minimas para requests/approvals. A M2.20.3
criou a UI do prestador para ver categorias sensiveis, abrir pedido de
...
recomendado era M2.20.9 - UI profissional de escolha de servico. A M2.20.9
aplicou a taxonomia no `NovoPedidoScreen` e no `PrestadorSettingsScreen`,
...
servicos em categoria oficial. A M2.20.9.2 ampliou a politica para admissao
global de servicos, cobrindo allow, sensitiveReview, block e unknownReview,
incluindo violencia criminal, exploracao de menores, trafico humano, drogas,
armas, fraude, falsificacao, terrorismo, procedimentos medicos ilegais e outros
crimes. A M2.20.10 fechou o QA final do catalogo
...
com Rules de ownership/admin. A M2.20.3 criou a secao de categorias sensiveis
no `PrestadorSettingsScreen`, o formulario de pedido, status de pedido/aprovacao
e reenvio quando o status for `needs_more_info`. A M2.20.4 criou a fila admin
...
### M2.20.7 - Catalogo Profissional e Intencao de Servico
...
compatibilidade com `Servico`. A M2.20.9 aplicou essa experiencia profissional
...
entram em search/matching por termos custom permitidos. A M2.20.9.2 reforcou a
politica global de admissao e o bloqueio de servicos ilicitos tambem nesse
trilho. A M2.20.10 fechou o
QA final do catalogo profissional e estabilizou o trilho M2.20.7 -> M2.20.10 no
